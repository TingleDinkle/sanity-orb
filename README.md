...
THE Internet Mood Ring. However, that idea wasn't feasible for me monetary-wise and time wise considering i'm stil quite choppy on data handling. So I decided to learn about the frontend libs and make a truly beautiful orb out of it.
